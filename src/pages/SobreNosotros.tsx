...
export default function SobreNosotros() {
  return (
    <div className='flex min-h-screen bg-gradient-to-br from-[#0a1612] via-[#0d1d17] to-[#0a1612] text-offwhite'>
      ...
      {/* Main content */}
      <div className='flex-1 md:ml-0 pt-16 md:pt-0 pb-20 md:pb-0'>
        {/* Hero Section */}
        ...
        <section className='max-w-6xl mx-auto px-6 py-12 md:py-16'>
          ...
          <div className='mb-16'>
            <p className='text-base md:text-lg text-grisClaro leading-relaxed'>
              En el corazón de la revolución digital está la colaboración. CodeConnect nació con la
              visión de crear un espacio donde desarrolladores, programadores y entusiastas de la
              tecnología puedan conectarse, aprender y colaborar de manera sin igual. Somos una
              comunidad global apasionada por el código y estamos comprometidos a ofrecer un entorno
              inclusivo e inspirador para todos los niveles de habilidad.
            </p>
          </div>
          ...
          <div className='grid md:grid-cols-2 gap-8 md:gap-12 items-center mb-16'>
            <div>
              ...
              <p className='text-base md:text-lg text-grisClaro leading-relaxed'>
                En CodeConnect, creemos que la colaboración es la esencia de la innovación. Nuestra
                misión es ofrecer una plataforma donde las mentes creativas puedan unirse, compartir
                conocimientos y desarrollar proyectos extraordinarios. Ya seas un principiante con
                ganas de aprender o un veterano con experiencia, aquí encontrarás un hogar para tus
          ...
          <div className='bg-gradient-to-r from-grisOscuro/50 to-verdeDestaque/10 rounded-2xl p-8 md:p-12 border border-verdeDestaque/20'>
            ...
            <p className='text-base md:text-lg text-grisClaro leading-relaxed mb-8'>
              Estamos emocionados de tenerte con nosotros en este emocionante viaje. Únete a nuestra
              vibrante comunidad y descubre el poder de la colaboración en el mundo del código.
            </p>
